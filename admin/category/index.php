            ...
            <div class="h-100" id="left-side-menu-container" data-simplebar>
                ...
                <ul class="metismenu side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <ul class="side-nav-second-level" aria-expanded="false">
                            <li>
                                <a href="../category">Loại hàng</a>
                            </li>
                            <li>
                                <a href="../category/add_category.php">Thêm mới loại hàng </a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10 ">
                            <a href="../category/add_category.php" class="btn btn-info">add new categories</a>
                                    ...
                                    <?php foreach ($result as $each) { ?>
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <a href="./edit_categories.php?id=<?php echo $each['id'] ?>"  class="action-icon text-warning">
                                                    <i class="mdi mdi-pencil"></i>
                                                </a>
                                                <a href="./delete_categories.php?id=<?php echo $each['id'] ?>" id="delete"  class="action-icon text-danger">
