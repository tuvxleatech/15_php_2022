...
<head>
    <meta charset="utf-8" />
    <title>Product Details | Hyper - Responsive Bootstrap 4 Admin Dashboard</title>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                                    ...
                                                    <a href="login-2.html" class="dropdown-item">Login 2</a>
                                                    <a href="register.html" class="dropdown-item">Register</a>
                                                    <a href="register-2.html" class="dropdown-item">Register 2</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <form class="pl-lg-4">
                                                <!-- Product title -->
                                                <h3 class="mt-0">Amazing Modern Chair (Orange) <a href="javascript: void(0);" class="text-muted"><i class="mdi mdi-square-edit-outline ml-2"></i></a> </h3>
